...
1. SHOULD: API responses SHOULD use Laravel resource classes or consistent JSON response formatting to maintain contract stability

## Policy Block

- SHOULD API responses SHOULD use Laravel resource classes or consistent JSON response formatting to maintain contract stability
