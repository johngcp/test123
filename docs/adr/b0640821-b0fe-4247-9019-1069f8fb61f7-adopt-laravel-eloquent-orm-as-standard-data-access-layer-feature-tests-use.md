...
1. SHOULD: Feature tests SHOULD use model factories and database transactions to ensure test isolation

## Policy Block

- SHOULD Feature tests SHOULD use model factories and database transactions to ensure test isolation
