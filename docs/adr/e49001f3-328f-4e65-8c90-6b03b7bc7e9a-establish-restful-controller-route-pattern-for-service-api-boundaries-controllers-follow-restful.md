...
1. MUST: Controllers MUST follow RESTful naming conventions (index, show, store, update, destroy) for resource-based operations

## Policy Block

- MUST Controllers MUST follow RESTful naming conventions (index, show, store, update, destroy) for resource-based operations
