...
1. MUST: Applications MUST follow Laravel's standard directory structure with bootstrap/, config/, app/, database/, public/, and tests/ directories

## Policy Block

- MUST Applications MUST follow Laravel's standard directory structure with bootstrap/, config/, app/, database/, public/, and tests/ directories
