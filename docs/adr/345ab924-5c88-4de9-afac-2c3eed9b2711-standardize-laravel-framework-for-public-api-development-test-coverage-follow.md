...
1. SHOULD: API test coverage SHOULD follow Laravel testing conventions with separate Feature tests for HTTP endpoints and Unit tests for business logic

## Policy Block

- SHOULD API test coverage SHOULD follow Laravel testing conventions with separate Feature tests for HTTP endpoints and Unit tests for business logic
