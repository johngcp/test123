...
1. SHOULD: Route-to-controller mappings SHOULD use explicit method references rather than string-based routing to enable static analysis and refactoring tools

## Policy Block

- SHOULD Route-to-controller mappings SHOULD use explicit method references rather than string-based routing to enable static analysis and refactoring tools
