...
1. MUST: All Laravel projects MUST maintain separate tests/Unit and tests/Feature directories for organizing tests by scope

## Policy Block

- MUST All Laravel projects MUST maintain separate tests/Unit and tests/Feature directories for organizing tests by scope
