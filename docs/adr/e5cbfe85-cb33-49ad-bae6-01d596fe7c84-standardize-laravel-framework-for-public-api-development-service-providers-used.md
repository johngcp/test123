...
1. MUST: Service providers MUST be used to register API-related services, bindings, and configuration in the Laravel service container (AppServiceProvider pattern)

## Policy Block

- MUST Service providers MUST be used to register API-related services, bindings, and configuration in the Laravel service container (AppServiceProvider pattern)
