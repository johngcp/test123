...
1. MUST: All database schema changes MUST be implemented as Laravel migration files in the database/migrations directory

## Policy Block

- MUST All database schema changes MUST be implemented as Laravel migration files in the database/migrations directory
