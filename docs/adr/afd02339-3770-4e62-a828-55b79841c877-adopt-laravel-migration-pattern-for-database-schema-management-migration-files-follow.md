...
1. MUST: Migration files MUST follow the naming convention YYYY_MM_DD_HHMMSS_descriptive_name.php where the timestamp ensures execution order

## Policy Block

- MUST Migration files MUST follow the naming convention YYYY_MM_DD_HHMMSS_descriptive_name.php where the timestamp ensures execution order
