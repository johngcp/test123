...
1. MUST: API data models MUST use Laravel Eloquent ORM with explicit relationship definitions, fillable/guarded properties, and type casting for consistent data access patterns

## Policy Block

- MUST API data models MUST use Laravel Eloquent ORM with explicit relationship definitions, fillable/guarded properties, and type casting for consistent data access patterns
