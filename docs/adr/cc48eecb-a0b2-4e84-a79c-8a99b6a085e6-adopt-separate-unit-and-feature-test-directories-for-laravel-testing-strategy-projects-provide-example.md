...
1. SHOULD: Projects SHOULD provide example tests in both directories to demonstrate proper usage patterns for new team members

## Policy Block

- SHOULD Projects SHOULD provide example tests in both directories to demonstrate proper usage patterns for new team members
