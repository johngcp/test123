...
1. MUST: All new web applications MUST use Laravel framework as the foundational application structure

## Policy Block

- MUST All new web applications MUST use Laravel framework as the foundational application structure
