...
1. SHOULD: Controllers SHOULD extend the base Controller class and be organized in app/Http/Controllers/ directory

## Policy Block

- SHOULD Controllers SHOULD extend the base Controller class and be organized in app/Http/Controllers/ directory
