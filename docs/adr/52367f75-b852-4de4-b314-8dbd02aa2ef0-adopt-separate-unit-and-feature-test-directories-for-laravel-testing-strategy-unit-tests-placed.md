# Adopt Separate Unit and Feature Test Directories for Laravel Testing Strategy: Unit Tests Placed
...
1. MUST: Unit tests MUST be placed in tests/Unit and MUST test individual classes or methods in isolation without booting the Laravel application framework

## Policy Block

- MUST Unit tests MUST be placed in tests/Unit and MUST test individual classes or methods in isolation without booting the Laravel application framework
