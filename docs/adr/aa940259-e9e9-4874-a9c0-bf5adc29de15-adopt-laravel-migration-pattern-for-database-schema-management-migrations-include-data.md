...
1. MAY: Migrations MAY include data seeding operations when the data is essential for schema functionality, though separate seeders are preferred for test data

## Policy Block

- MAY Migrations MAY include data seeding operations when the data is essential for schema functionality, though separate seeders are preferred for test data
