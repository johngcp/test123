# Adopt Separate Unit and Feature Test Directories for Laravel Testing Strategy: Feature Tests Placed
...
1. MUST: Feature tests MUST be placed in tests/Feature and MUST test end-to-end functionality including HTTP requests, routing, middleware, and database interactions

## Policy Block

- MUST Feature tests MUST be placed in tests/Feature and MUST test end-to-end functionality including HTTP requests, routing, middleware, and database interactions
