...
1. MUST: Database schema changes MUST be implemented using Laravel migrations stored in database/migrations/ with timestamp-prefixed filenames

## Policy Block

- MUST Database schema changes MUST be implemented using Laravel migrations stored in database/migrations/ with timestamp-prefixed filenames
