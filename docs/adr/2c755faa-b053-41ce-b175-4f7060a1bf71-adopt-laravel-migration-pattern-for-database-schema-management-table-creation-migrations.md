...
1. SHOULD: Table creation migrations SHOULD include appropriate indexes, foreign key constraints, and default values at creation time

## Policy Block

- SHOULD Table creation migrations SHOULD include appropriate indexes, foreign key constraints, and default values at creation time
