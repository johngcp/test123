...
1. MUST: Schema modifications MUST use Laravel's Schema Builder facade (Schema::create, Schema::table, Schema::drop) rather than raw SQL DDL statements

## Policy Block

- MUST Schema modifications MUST use Laravel's Schema Builder facade (Schema::create, Schema::table, Schema::drop) rather than raw SQL DDL statements
