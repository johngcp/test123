...
1. MUST: Database seeders MUST use Eloquent model factories or model create methods for data population

## Policy Block

- MUST Database seeders MUST use Eloquent model factories or model create methods for data population
