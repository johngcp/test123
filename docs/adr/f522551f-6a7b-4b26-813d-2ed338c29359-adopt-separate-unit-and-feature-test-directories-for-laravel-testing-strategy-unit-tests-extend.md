...
1. SHOULD: Unit tests SHOULD extend PHPUnit\Framework\TestCase rather than Tests\TestCase to avoid loading the full Laravel framework

## Policy Block

- SHOULD Unit tests SHOULD extend PHPUnit\Framework\TestCase rather than Tests\TestCase to avoid loading the full Laravel framework
