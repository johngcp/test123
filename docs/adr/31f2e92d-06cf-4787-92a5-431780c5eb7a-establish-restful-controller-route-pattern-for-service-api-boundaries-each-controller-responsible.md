...
1. SHOULD: Each controller SHOULD be responsible for a single resource or closely related set of operations to maintain single responsibility principle

## Policy Block

- SHOULD Each controller SHOULD be responsible for a single resource or closely related set of operations to maintain single responsibility principle
