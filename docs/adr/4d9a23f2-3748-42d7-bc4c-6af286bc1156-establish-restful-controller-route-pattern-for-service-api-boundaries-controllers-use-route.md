...
1. MAY: Controllers MAY use route model binding to automatically resolve resource instances from route parameters

## Policy Block

- MAY Controllers MAY use route model binding to automatically resolve resource instances from route parameters
