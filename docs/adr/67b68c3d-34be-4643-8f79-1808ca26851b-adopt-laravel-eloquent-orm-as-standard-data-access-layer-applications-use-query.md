...
1. MAY: Applications MAY use the Query Builder directly for complex reporting queries that do not map to single model operations

## Policy Block

- MAY Applications MAY use the Query Builder directly for complex reporting queries that do not map to single model operations
