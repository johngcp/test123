...
1. MUST: All HTTP API endpoints MUST be defined through dedicated controller classes that handle request/response transformation

## Policy Block

- MUST All HTTP API endpoints MUST be defined through dedicated controller classes that handle request/response transformation
