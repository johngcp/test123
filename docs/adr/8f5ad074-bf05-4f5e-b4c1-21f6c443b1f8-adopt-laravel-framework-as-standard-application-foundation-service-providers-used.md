...
1. SHOULD: Service providers SHOULD be used to register application services and dependencies in the service container

## Policy Block

- SHOULD Service providers SHOULD be used to register application services and dependencies in the service container
