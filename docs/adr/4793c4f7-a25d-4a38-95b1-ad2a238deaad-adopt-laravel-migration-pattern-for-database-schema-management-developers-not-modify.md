...
1. MUST_NOT: Developers MUST NOT modify existing migration files that have been committed and deployed to shared environments

## Policy Block

- MUST_NOT Developers MUST NOT modify existing migration files that have been committed and deployed to shared environments
