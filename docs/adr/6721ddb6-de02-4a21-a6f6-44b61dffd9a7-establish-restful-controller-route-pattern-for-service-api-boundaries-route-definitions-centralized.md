...
1. MUST: Route definitions MUST be centralized in routing configuration files (e.g., routes/web.php, routes/api.php) and MUST NOT be scattered throughout the codebase

## Policy Block

- MUST Route definitions MUST be centralized in routing configuration files (e.g., routes/web.php, routes/api.php) and MUST NOT be scattered throughout the codebase
