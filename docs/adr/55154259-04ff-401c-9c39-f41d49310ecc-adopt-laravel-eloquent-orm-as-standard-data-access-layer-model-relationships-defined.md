...
1. SHOULD: Model relationships SHOULD be defined using Eloquent relationship methods (hasMany, belongsTo, etc.) rather than manual joins

## Policy Block

- SHOULD Model relationships SHOULD be defined using Eloquent relationship methods (hasMany, belongsTo, etc.) rather than manual joins
