...
1. SHOULD: Complex queries SHOULD be encapsulated in model scopes or repository methods rather than inline in controllers

## Policy Block

- SHOULD Complex queries SHOULD be encapsulated in model scopes or repository methods rather than inline in controllers
