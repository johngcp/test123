...
1. SHOULD: Models SHOULD extend Illuminate\Database\Eloquent\Model and be placed in app/Models/ directory

## Policy Block

- SHOULD Models SHOULD extend Illuminate\Database\Eloquent\Model and be placed in app/Models/ directory
