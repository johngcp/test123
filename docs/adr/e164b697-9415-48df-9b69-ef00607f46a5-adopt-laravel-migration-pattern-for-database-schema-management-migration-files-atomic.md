...
1. SHOULD: Migration files SHOULD be atomic, focusing on a single logical schema change to enable granular rollbacks

## Policy Block

- SHOULD Migration files SHOULD be atomic, focusing on a single logical schema change to enable granular rollbacks
