...
- **R-UNIT-001** MUST: Unit tests MUST be placed in tests/Unit and MUST test individual classes or methods in isolation without booting the Laravel application framework.
