...
These rules are ALWAYS ACTIVE for all PHPUnit test files in Laravel projects and govern test organization strategy.

### Rules

- **R-FEAT-001** MUST: Feature tests MUST be placed in tests/Feature and MUST test end-to-end functionality including HTTP requests, routing, middleware, and database interactions.
