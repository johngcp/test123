...
- **R-MIGRATION-001** MUST: Each migration class MUST extend Laravel's Migration base class and implement both up() and down() methods for forward and rollback operations.
...
<enforcement>
Claude Code MUST NOT skip or defer verification of migration file structure and naming conventions. All migrations MUST be validated against these rules before acceptance.
</enforcement>